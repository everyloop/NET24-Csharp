...
|Exekvera|Execute|Köra kod.|Fil som slutar på .exe (I Windows) är exekverbar (körbar)
|Explicit|Explicit|Betyder "Uttryckligen". I programmering, något som uttryckligen beskrivs i koden.|T.ex en explicit konvertering, där vi uttyckligen skriver vad som ska konverteras.
...
|Implicit|Implicit|Betyder "Underförstått". I programmering något som inte skrivs i koden, utan är underförsått.|T.ex en implicit konvertering, som automatisk konverterar utan att det skrivs i koden.|
|Indentering|Indentation|Raderna i källkoden dras in så att de avspeglar progammets struktur||
|Indexering|Indexing|Välja ut ett specifikt element ur en lista, array, sträng eller liknande med hjälp av ett index.|Ex: myIntArray[5] = 3;|
